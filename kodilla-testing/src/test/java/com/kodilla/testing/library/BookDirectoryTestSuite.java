...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testBorrowedBooksList(){
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser1 = new LibraryUser("First name1", "Last name1", "01");
        LibraryUser libraryUser2 = new LibraryUser("First name2", "Last name2", "02");
        LibraryUser libraryUser3 = new LibraryUser("First name3", "Last name3", "03");
        List<Book> resultListOf0Books = new ArrayList<>();
